...
import { X, Home, Building2, MapPin, Bed, Bath, Maximize2, Layers, DollarSign, ExternalLink, Edit, RefreshCw, Trash2 } from 'lucide-react';
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Apartamento</label>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Torre / Edificio</label>
                  <p className="text-sm text-gray-900">{apartamento.torre}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{apartamento.sucursal}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{apartamento.tipo}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Habitaciones</label>
                  <p className="text-sm text-gray-900">{apartamento.habitaciones}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Baños</label>
                  <p className="text-sm text-gray-900">{apartamento.banos}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Tamaño</label>
                  <p className="text-sm text-gray-900">{apartamento.tamano} m²</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <label className="block text-sm text-gray-600">Piso</label>
                  <p className="text-sm text-gray-900">{apartamento.piso}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <label className="block text-sm text-gray-600">Precio Mensual</label>
                <p className="text-sm text-gray-900">{apartamento.precioMensual.toFixed(2)} US$</p>
              </div>
            </div>
          </div>
