        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">{apartamento.numero} - {apartamento.torre}</p>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <label className="block text-sm text-gray-600 mb-1">Estado actual</label>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600 mt-1">{estado.description}</p>
                      </div>
                    </div>
                  </button>
                ))}
